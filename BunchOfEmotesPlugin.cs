...
namespace BunchOfEmotes
{
    ...
    public class BunchOfEmotesPlugin : BaseUnityPlugin
    {
        ...
        public static void initEmotes()
        {
            ...
            myCustomAnims[int.Parse("1097339540")] = "chair sit down";
            ...
            myCustomAnims[int.Parse("638283417")]=           "remoove bmx";
            ...
            myCustomAnims[int.Parse("-2115972706")]=         "weird air trick ";
            myCustomAnims[int.Parse("-496818058")]=          "walljump front flip";
